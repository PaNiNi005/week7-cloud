...
ปัญหา: Deploy Backend API ไม่ผ่าน เนื่องจากตั้งค่า Root Directory ผิด 
โดยไม่ได้ระบุ /api ทำให้ Railway พยายาม build จาก root ของ repository 
แล้วหา package.json ไม่เจอ ส่งผลให้ Build failed

วิธีแก้: เข้าไปที่ Settings ของ API Service แล้วแก้ Root Directory 
จาก / เป็น /api จากนั้น Redeploy ใหม่ ระบบก็ Build และ Deploy สำเร็จ
